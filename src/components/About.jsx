            ...
            <Grid className={classes.gridAbout} item xs={8}>
                <Paper className={classes.paperAbout}>
                    ...
                    <Typography className={classes.typo} variant='body1'>
                        Somos Alma y queremos ser en una aplicación para informar todo tu recorrido y a tus seres queridos. Para hacer posible esto combinamos la tecnología y el diseño centrado en las personas.                    
                    </Typography>
                </Paper>
                <Paper className={classes.paperAbout}>
                    <h2 className='feature-heading resaltado-violet-mach'>¿Que nos motivó?</h2>
                ...
                <Paper className={classes.paperAbout}>
                    ...
                    <Typography className={classes.typo}>
                        En Alma utilizamos el poder de la tecnología como principal motor de las soluciones que hacen más fácil la vida de las personas. Trabajamos día a día para que todos tengan la posibilidad de acceder a la información del destino de algún ser querido para poder estar seguros.
                    </Typography>
                </Paper>
                <Paper className={classes.paperAbout}>

                    <h2 className='feature-heading resaltado-violet-mach'>Misión</h2>
                    <Typography className={classes.typo}>
                ...
                <Paper className={classes.paperAbout}>
                    ...
                    <h2 className='feature-heading resaltado-violet-mach'>Visión</h2>
                    <Typography className={classes.typo}>
